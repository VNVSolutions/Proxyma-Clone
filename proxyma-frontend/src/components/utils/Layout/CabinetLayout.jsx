                    ...
                    <ul className='cabinetSideBarNav-submenu-list'>
                        ...
                        {openSubmenuProxy && <ul className="submenuCabinet-open-list">
                            <li className="submenuCabinet-open-item">
                                <NavLink to="#">Динамичиские</NavLink>
                            </li>
                            <li className="submenuCabinet-open-item">
